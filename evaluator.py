"""
Evaluator cloned from pan-code repository for the PAN21 Style Change Detection task.
Date: May 20, 2021
Availability: https://github.com/pan-webis-de/pan-code/tree/master/clef21/style-change-detection
"""
...
def main():
    ...
    for k, v in {"task1_score": task1_result, "task2_score": task2_results, "task3_score": task3_results}.items():
